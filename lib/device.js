...
class Device_Helper {
	 ...
	 ****************************************************************************/
	static async killDevice(platform, deviceName) {
		output.debug(`Killing ${platform} virtual device`)
		if(platform === 'iOS') {
			await killSim();
		} else if(platform === 'Android') {
			await killEmu(deviceName);
		}
	}
 ...
 ******************************************************************************/
async function killEmu(deviceName) {
